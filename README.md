...
<p align="center">
  <img src="images/qr-code.jpg" alt="森森 AI 笔记二维码" width="160">
  <br>
  <sub>扫码关注「森森 AI 笔记」</sub>
</p>
...
> 这是「森森 AI 笔记」维护的 [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness)（`dsh`）插件精选列表。
