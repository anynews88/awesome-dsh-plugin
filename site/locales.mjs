...
export default [
  {
    ...
    strings: {
      ...
      CONTRIB: '收录你的插件',
      CONTRIB_BODY: '给 <a href="https://github.com/anynews88/awesome-ash-plugin" rel="noopener">awesome-dsh-plugin</a> 提一个 PR：在每个 <code translate="no">README</code> 语言文件中各加一行，网站会自动同步。也请为你的仓库打上 <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic。',
      MOTTO: '探索未至之境',
  ...
  },
  {
    ...
    strings: {
      ...
      CONTRIB_BODY: 'Open a PR against <a href="https://github.com/anynews88/awesome-ash-plugin" rel="noopener">awesome-dsh-plugin</a> — one line each in every <code translate="no">README</code> language file; the site syncs automatically. Add the <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic to your repo too.',
