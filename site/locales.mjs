...
export default [
  {
    ...
    TITLE: '森森 AI 笔记 · DeepSeek Harness（dsh）插件精选',
    DESC: '「森森 AI 笔记」收录 {N} 个 DeepSeek Harness（dsh）插件：UI 增强、主题外观、会话记忆、工具与能力、技能包、工作流、通知集成、模型接入、开发与娱乐，含安装命令与仓库链接，持续更新。',
    KEYWORDS: '森森 AI 笔记,DeepSeek Harness 插件,dsh 插件,DeepSeek 插件,DeepSeek Harness 插件列表,DeepSeek Harness UI 增强,DeepSeek Harness 主题',
    SEARCH_PH: '搜索插件…',
    CAT_TITLE: '{CAT}插件 — 森森 AI 笔记 · DeepSeek Harness（dsh）精选',
    CAT_DESC: '「森森 AI 笔记」精选 DeepSeek Harness（dsh）{CAT}插件，共 {N} 个：功能描述、安装命令与仓库链接，持续更新。',
    COPY_LABEL: '复制安装命令',
    COPY_TEXT: '复制安装命令',
    categories: {
      ui: 'UI 增强',
    ...
    strings: {
      ...
      CONTRIB: '收录你的插件',
      CONTRIB_BODY: '给 <a href="https://github.com/anynews88/awesome-dsh-plugin" rel="noopener">awesome-dsh-plugin</a> 提一个 PR：在每个 <code translate="no">README</code> 语言文件中各加一行，网站会自动同步。也请为你的仓库打上 <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic。',
      MOTTO: '探索未至之境',
  ...
  },
  {
    ...
    TITLE: '森森 AI 笔记 · DeepSeek Harness (dsh) Plugin Curations',
    DESC: 'A curated list of {N} DeepSeek Harness (dsh) plugins by 森森 AI 笔记: UI, themes, sessions, memory, tools, skills, workflows, notifications, models & runtime, and fun — with install commands and repo links. Updated continuously.',
    KEYWORDS: '森森 AI 笔记,DeepSeek Harness plugins,dsh plugins,DeepSeek plugin list,DeepSeek Harness plugin registry,DeepSeek Harness UI plugins',
    SEARCH_PH: 'Search plugins…',
    CAT_TITLE: '{CAT} — 森森 AI 笔记 · DeepSeek Harness (dsh) Plugins',
    CAT_DESC: '{N} curated {CAT} plugins for DeepSeek Harness (dsh) by 森森 AI 笔记. Descriptions, install commands, and repo links — updated continuously.',
    ...
    strings: {
      ...
      CONTRIB_BODY: 'Open a PR against <a href="https://github.com/anynews88/awesome-dsh-plugin" rel="noopener">awesome-dsh-plugin</a> — one line each in every <code translate="no">README</code> language file; the site syncs automatically. Add the <a href="https://github.com/topics/dsh-plugin" rel="noopener"><code translate="no">dsh-plugin</code></a> topic to your repo too.',
